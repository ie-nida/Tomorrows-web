...
const HelpLanguageSelector = ({ currentLanguage, onChangeLanguage }) => {
  ...
  return (
    <div className="relative">
      <button 
        className="flex items-center space-x-2 bg-pink-500 hover:bg-pink-600 text-white font-medium py-1 px-3 rounded-full transition-colors language-selector"
...
export default HelpLanguageSelector;