...
const sidebarItems = [
  ...
  { title: 'Fruits & Items', href: '#fruits-items' },
  { title: 'Scoring', href: '#scoring' },
  { title: 'Difficulty Levels', href: '#difficulty-levels' },
  { title: 'Skinning', href: '#skinning' },
  {
    title: 'osu!catch Mapping',
    href: '#mapping',
    children: [
      { title: 'osu! conversion notes', href: '#conversion-notes' }
    ]
  },
  {
    title: 'Trivia',
    children: [
      { title: 'Gameplay', href: '#trivia-gameplay' },
...
const CatchSidebar = ({ isOpen }) => {
  if (!isOpen) return null;

  return (
    <aside className="w-64 bg-[#252525] border-r border-[#3a3a3a] overflow-y-auto">
      <div className="py-4">
        <div className="px-4 py-2 font-bold text-red-400 uppercase text-sm tracking-wider">
          CONTENTS
        </div>
