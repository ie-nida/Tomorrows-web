...
const ManiaSidebar  = ({ isOpen }) => {
  if (!isOpen) return null;

  return (
    <aside className="w-64 bg-[#252525] border-r border-[#3a3a3a] overflow-y-auto">
      <div className="py-4">
        <div className="px-4 py-2 font-bold text-purple-400 uppercase text-sm tracking-wider">
          CONTENTS
        </div>
