...
const LanguageSelector = ({ currentLanguage, onChangeLanguage }) => {
  ...
  return (
    <div className="relative">
      <button 
        className="flex items-center space-x-2 bg-purple-500 hover:bg-purple-600 text-black font-medium py-1 px-3 rounded-full transition-colors language-selector"
