...
import CatchSidebar from './CatchSidebar';
import LanguageSelector from './LanguageSelector';
import CatchMainContent from './CatchMainContent';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#1a1a1a] text-white">
      ...
      <div className="flex flex-1 overflow-hidden">
        <CatchSidebar isOpen={isSidebarOpen} />
        <CatchMainContent isLoading={isLoading} currentLanguage={currentLanguage} />
      </div>
    </div>
  );
}
